            ...
            >
                <FormLayout>
                    ...
                    <FormCard title="Bill Details">
                        <Select label="Bill Type" options={billTypeOptions} value={form.data.bill_type} onChange={(e) => form.setData('bill_type', e.target.value)} error={form.errors.bill_type} />
                        <Input label="Bill Name" placeholder="e.g. Globe Postpaid – Main Office" value={form.data.name} onChange={(e) => form.setData('name', e.target.value)} error={form.errors.name} />
                        <FormRow>
                        ...
                        <FormRow>
                            <Input label="Amount (PHP)" type="number" min="0" step="0.01" value={form.data.amount} onChange={(e) => form.setData('amount', e.target.value)} error={form.errors.amount} />
