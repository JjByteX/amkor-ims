            ...
            >
                <FormLayout split="5fr 7fr 5fr">
                    ...
                    <FormCard title="Voucher & Payee">
                        ...
                        <Input label="Payee" required value={data.payee} onChange={(e) => setData('payee', e.target.value)} error={errors.payee} placeholder="Payee name" />
                    ...
                    <FormCard title="Details & Amount">
                        ...
                        <FormRow>
                            <Input label="Amount (PHP)" required type="number" step="0.01" value={data.amount} onChange={(e) => setData('amount', e.target.value)} error={errors.amount} placeholder="0.00" />
