            ...
            >
                <FormLayout>
                    ...
                    <FormCard title="Payment Details">
                        ...
                        <Input label="Operator Name" required placeholder="Name stored on record" value={form.data.operator_name} onChange={(e) => form.setData('operator_name', e.target.value)} error={form.errors.operator_name} />
                        <FormRow>
                        ...
                        <FormRow>
                            <Input label="Amount (PHP)" required type="number" min="0.01" step="0.01" value={form.data.amount} onChange={(e) => form.setData('amount', e.target.value)} error={form.errors.amount} />
