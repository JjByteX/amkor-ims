    ...
    public function run(): void
    {
        ...
        $collectibles = [
            [
                ...
                'due_date' => '2026-02-01', 'status' => 'paid',
            ...
            [
                ...
                'balance_php' => 0, 'balance_usd' => 0,
                'due_date' => '2026-03-05', 'status' => 'paid',
            ...
            [
                ...
                'balance_php' => 0, 'balance_usd' => 0,
                'due_date' => '2026-01-05', 'status' => 'paid',
            ...
            [
                ...
                'due_date' => '2026-03-10', 'status' => 'overdue',
            ...
            [
                ...
                'due_date' => '2026-05-01', 'status' => 'current',
                'approval_status' => 'pending',
                'or_number' => null, 'branch_id' => $visaCentre,
                'created_by' => $visa, 'updated_by' => $visa,
                'created_at' => $now, 'updated_at' => $now,
            ...
            [
                ...
                'balance_php' => 0, 'balance_usd' => 0,
                'due_date' => '2026-01-25', 'status' => 'paid',
