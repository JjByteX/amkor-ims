    ...
    public function run(): void
    {
        ...
        $payables = [
            [
                ...
                'due_date' => '2026-01-20', 'days_outstanding' => 0,
            ...
            [
                ...
                'balance_php' => 0, 'balance_usd' => 0, 'balance_jpy' => 0,
                'due_date' => '2026-02-15', 'days_outstanding' => 0,
            ...
            [
                ...
                'balance_php' => 0, 'balance_usd' => 0, 'balance_jpy' => 0,
                'due_date' => '2026-03-15', 'days_outstanding' => 0,
            ...
            [
                ...
                'balance_php' => 0, 'balance_usd' => 0, 'balance_jpy' => 0,
                'due_date' => '2026-04-15', 'days_outstanding' => 0,
            ...
            [
                ...
                'due_date' => '2026-05-01', 'days_outstanding' => 38, 'status' => 'overdue',
            ...
            [
                ...
                'due_date' => '2026-06-01', 'days_outstanding' => 7, 'status' => 'current',
                'approval_status' => 'pending', 'checked_by' => null, 'checked_at' => null,
                'approved_by' => null, 'approved_at' => null,
                'released_by' => null, 'released_at' => null,
                'mode_of_payment' => null,
            ...
            [
                ...
                'due_date' => '2026-06-15', 'days_outstanding' => 0, 'status' => 'current',
